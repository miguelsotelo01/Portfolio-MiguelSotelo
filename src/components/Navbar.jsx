...
/>
        ...
        >
          <span className={`h-1 w-full bg-slate-900 dark:bg-white rounded-full transition-all duration-300 ${isOpen ? 'rotate-45 translate-y-2.5' : ''}`}></span>
<span className={`h-1 w-full bg-slate-900 dark:bg-white rounded-full transition-all duration-300 ${isOpen ? 'opacity-0' : ''}`}></span>
<span className={`h-1 w-full bg-slate-900 dark:bg-white rounded-full transition-all duration-300 ${isOpen ? '-rotate-45 -translate-y-2.5' : ''}`}></span>
        </button>
        ...
        `}>
          <ul className="flex flex-col xl:flex-row list-none gap-8 text-2xl xl:text-base font-medium">
            <li className="cursor-pointer text-slate-900 dark:text-white hover:bg-[#ff4900] xl:hover:bg-transparent xl:hover:text-[#ff4900] p-4 transition-colors" onClick={() => scrollToSection('about')}>
              {t('nav.about')}
              </li>
            <li className="cursor-pointer text-slate-900 dark:text-white hover:bg-[#ff4900] xl:hover:bg-transparent xl:hover:text-[#ff4900] p-4 transition-colors" onClick={() => scrollToSection('services')}>{t('nav.services')}</li>
            <li className="cursor-pointer text-slate-900 dark:text-white hover:bg-[#ff4900] xl:hover:bg-transparent xl:hover:text-[#ff4900] p-4 transition-colors" onClick={() => scrollToSection('portfolio')}>{t('nav.portfolio')}</li>
            <li className="cursor-pointer text-slate-900 dark:text-white hover:bg-[#ff4900] xl:hover:bg-transparent xl:hover:text-[#ff4900] p-4 transition-colors" onClick={() => scrollToSection('contact')}>{t('nav.contact')}</li>
          </ul>
          <button 
  onClick={toggleTheme}
