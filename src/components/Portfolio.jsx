...
const ProjectCard = ({ project, t }) => (
  <div className="group relative h-[350px] overflow-hidden rounded-lg cursor-pointer animate-fadeIn border border-slate-200 dark:border-white/10 shadow-sm hover:shadow-md transition-all duration-300">
    ...
    <div className="absolute inset-0 bg-[#ff4900]/90 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-all duration-400 flex flex-col items-center justify-center text-center px-6">
      ...
      {/* Enlace real configurado para la v2.1 */}
      <a
        href={project.links.repo}
        target="_blank"
        rel="noopener noreferrer"
        className="mt-6 text-2xl transform translate-y-10 group-hover:translate-y-0 transition-transform duration-300 delay-150 hover:scale-125 transition-all"
      >
