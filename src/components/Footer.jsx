...
const Footer = () => {
  ...
  return (
    <footer id="contact" className="w-full border-t-2 border-slate-200 dark:border-white py-16 px-6 transition-colors duration-500">
      ...
      <div className="max-w-6xl mx-auto px-4 lg:px-12 grid grid-cols-1 md:grid-cols-3 gap-12 text-center md:text-left">
        ...
        <div className="flex flex-col items-center md:items-start space-y-4">
          <h3 className="text-xl font-bold text-slate-900 dark:text-white uppercase tracking-wider">{t('footer.socials_title')}</h3>
          ...
          <div className="flex justify-center md:justify-start gap-6 pt-4 ">
            <a href="https://github.com/miguelsotelo01" target="_blank" rel="noreferrer" className="text-3xl text-slate-400 dark:text-[#a3a3a3] hover:text-[#ff4900] transition-colors duration-300">
              <i className="fa-brands fa-github"></i>
            </a>
            <a href="https://www.youtube.com/@miky.a.sotelo" target="_blank" rel="noreferrer" className="text-3xl text-slate-400 dark:text-[#a3a3a3] hover:text-[#ff4900] transition-colors duration-300">
              <i className="fa-brands fa-youtube"></i>
            </a>
            <a href="https://www.linkedin.com/in/miguel-a-sotelo/" target="_blank" rel="noreferrer" className="text-3xl text-slate-400 dark:text-[#a3a3a3] hover:text-[#ff4900] transition-colors duration-300">
        ...
        <div className="flex flex-col items-center md:items-center space-y-4">
          <h3 className="text-xl font-bold text-slate-900 dark:text-white uppercase tracking-wider">{t('footer.contact_title')}</h3>
        ...
        <div className="flex flex-col items-center md:items-end space-y-4">
          <h3 className="text-xl font-bold text-slate-900 dark:text-white uppercase tracking-wider md:text-right">{t('footer.services_title')}</h3>
