      ...
      <div className="flex flex-col lg:flex-row items-center justify-between w-full max-w-6xl mx-auto gap-10 lg:gap-20 px-4 lg:px-12">
        ...
        <div className="w-full lg:flex-1 flex justify-center order-1 lg:order-2">
          <div className="relative group">
            ...
            <img 
              src={fotoPerfil} 
              alt="Miguel Sotelo" 
              className="relative w-full max-w-[280px] md:max-w-[350px] lg:max-w-[450px] aspect-square object-cover rounded-2xl border-4 border-[#ff4900]/20"
            />
          </div>
        </div>
        ...
        <div className="w-full lg:flex-1 text-center lg:text-left order-2 lg:order-1">
          ...
          <div className="inline-block relative bg-[#ff4900] text-white px-6 py-2 mb-6 rounded-sm shadow-lg">
            <span className="text-sm md:text-base font-bold uppercase tracking-wider">Hola, Yo soy</span>
          ...
          <h1 className="text-4xl sm:text-6xl lg:text-8xl font-black mb-4 leading-tight">
          ...
          <p className="text-gray-400 text-lg md:text-2xl mb-10 max-w-lg mx-auto lg:mx-0">
            Desarrollador Web con enfoque en soluciones escalables y diseño moderno.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start">
            ...
            <button 
              ...
              className="w-full sm:w-auto border-2 border-white text-white px-10 py-4 rounded-xl font-bold hover:bg-white hover:text-black transition-all duration-300"
            >
              Mi trabajo
            </button>
          </div>
