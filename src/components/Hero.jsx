...
const Hero = () => {
  ...
  return (
    // Correcciones : se cambio 'lg:pt-0' por 'lg:pt-28' (aprox 112px)
    ...
    <section
      id="home"
      className="min-h-screen flex items-center justify-center pt-20 pb-12 lg:pt-28 lg:pb-0 px-6"
    >
      <div className="flex flex-col lg:flex-row items-center justify-between w-full max-w-6xl mx-auto gap-10 lg:gap-20 px-4 lg:px-12">
        ...
        <div className="w-full lg:flex-1 text-center lg:text-left order-2 lg:order-1">
          {/* La burbuja ya no está tapada por el nav */}
